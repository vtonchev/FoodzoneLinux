    ...
    <b-col class="p-0 position-static">
        ...
        <b-col cols="12" class="p-0 position-static">
            <b-breadcrumb class="route">
                ...
                <b-breadcrumb-item active>{{$store.state.subcategories[$route.params.category].find(({id}) => id === $route.params.subcategory).title}}({{rows}})</b-breadcrumb-item>
            </b-breadcrumb>
        ...
        <b-col cols="12" class='p-0'>
            <b-row class="m-0">
                <b-col cols='6' sm='4' lg='3' class="p-0 mb-3" v-for='product in products' :key='product._id'>
                    <Card 
